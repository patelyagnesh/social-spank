...
<!-- Mirrored from wpkixx.com/html/socimo/feed.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Apr 2021 05:42:35 GMT -->
<head>
							...
							<div class="col-lg-3">
								<aside class="sidebar static left">
									<div class="widget web-links stick-widget">
										<h4 class="widget-title">Useful Links <a title="" href="#" class="see-all"></a></h4>
										<ul>
											<li><i class="icofont-dotted-right"></i> <a title="Profile" href="./ProfileServlet">Profile</a></li>
											<li><i class="icofont-dotted-right"></i> <a title="Notifications" href="./NotificationServlet">Notifications</a></li>
										</ul>
									</div><!-- links -->
								</aside>
							</div>
									...
									<div class="user-post">
										<div class="friend-info">
											...
											<div class="friend-name">
													...
													<div class="more-post-optns">
														...
														<ul>
															<li>
																...
																<a title="" class="share-to" href="./EditPostPopup.jsp?postid=${post.getPostID()}&content=${post.getContent()}"> Edit Post</a>
																<span>Edit This Post within a Minute</span>
															</li>
															<li>
																<i class="icofont-ui-delete"></i>
																<a title="" class="delete-post" href="./DeletePostServlet?postId=${post.getPostID()}"> Delete Post</a>
												...
												<ins>
													<a title="verified" href="time-line.html">${post.getName()}</a></ins>
												<span><i class="icofont-globe"></i> published : ${post.getLastUpdatedDate()}</span>
											</div>
											<div class="post-meta">
												<p>
													${post.getContent()}
												...
												<div class="stat-tools">
													<a href="./LikePostServlet?postId=${post.getPostID()}&likeCode=1" class="like-to"><i class="icofont-like"></i>${post.getNbLikes()} Like</a>
													<a href="./LikePostServlet?postId=${post.getPostID()}&likeCode=2" class="like-to"><i class="icofont-thumbs-down"></i> UnLike</a>
													<a title="" href="./SavedPostServlet?postId=${post.getPostID()}&type=1" class="save-to"><i class="icofont-save"></i> Save</a>
												</div>
											</div>
										</div>
									</div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></i>Create New Post</h5>
				...
				<div class="post-new">
					<form method="post" class="c-form" action="./PostServlet">
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-share-2"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"></line><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"></line></svg></i>
    ...
    <div class="share-wraper">
	    <div class="share-options">
			...
			<h5><i>
			<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-share"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"></path><polyline points="16 6 12 2 8 6"></polyline><line x1="12" y1="2" x2="12" y2="15"></line></svg></i>Edit Post</h5>
			<form method="post" action="./EditPostServlet">
				<textarea name="newContent" placeholder="Write Something..!"></textarea>
			</form>
...
<!-- Mirrored from wpkixx.com/html/socimo/feed.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Apr 2021 05:44:29 GMT -->
</html>